...
Figure 12 uses a box-plot to show potential driver age outliers for winning drivers - these are included for model 1 but excluded for model 2 (see Predictive Modelling section).
