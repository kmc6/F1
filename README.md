...
Key insights from UA underline the fact that many elements of F1 have changed since 1950.

Fo example, in the USA different circuits have been raced at in different locations to make the sport more appealing to sports fans (figure 6). 
```python
